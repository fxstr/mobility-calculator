...
var createDefaultStream = __webpack_require__(35);
var Test = __webpack_require__(38);
...
exports.default = getHighAndLowHours;
function getHighAndLowHours(start, duration) {
	var now = new Date(2000, 0, 1, start.hours, start.minutes, 0, 0);
	var durationInMinutes = duration.hours * 60 + duration.minutes;
	var result = {
		low: 0,
		high: 0
	};
	...
	for (var i = 0; i < durationInMinutes; i++) {
		...
		if (now.getHours() < 7 || now.getHours() === 7 && now.getMinutes() === 0 || now.getHours() === 23 && now.getMinutes() !== 0) {
			result.low++;
			//console.log('was low');
		} else {
			result.high++;
...
function parseTime(value, timeOfDay) {
...
var _mobx = __webpack_require__(32);

var _parseTime = __webpack_require__(21);
...
var _getHighAndLowHours = __webpack_require__(20);

var _getHighAndLowHours2 = _interopRequireDefault(_getHighAndLowHours);
...
var log = (0, _debug2.default)('mobility:Ride');

var Ride = (_class = function () {

	/**
 * ID's needed for iterating (React key)
 */
	function Ride(id, categories) {
		(0, _classCallCheck3.default)(this, Ride);

		_initDefineProp(this, 'category', _descriptor, this);

		_initDefineProp(this, 'startTime', _descriptor2, this);

		_initDefineProp(this, 'duration', _descriptor3, this);

		_initDefineProp(this, 'distance', _descriptor4, this);
	...
	(0, _createClass3.default)(Ride, [{
		...
		value: function validateStartTime(value) {
			this.startTime.value = undefined;
			this.startTime.error = undefined;
			var parsed = void 0;
			try {
				parsed = (0, _parseTime2.default)(value, true);
		...
		value: function validateDuration(value) {
			this.duration.value = undefined;
			this.duration.error = undefined;
			var parsed = void 0;
			try {
				parsed = (0, _parseTime2.default)(value);
		...
		key: 'validateDistance',
		value: function validateDistance(value) {
		...
		key: 'highAndLowMinutes',
		get: function get() {
			if (!this.duration.value || !this.startTime.value) return undefined;
			return (0, _getHighAndLowHours2.default)(this.startTime.value, this.duration.value);
		}
	}, {
		key: 'newCost',
		get: function get() {
			if (!this.highAndLowMinutes || !this.distance.value) return undefined;
			var cost = this.category.newPricing.pricePerHourLow / 60 * (this.highAndLowMinutes.low + this.highAndLowMinutes.high);
			cost += this.category.newPricing.pricePerKmFew * this.distance.value;
			return cost;
		}
	}, {
		key: 'newToOldDifference',
		get: function get() {
		...
		get: function get() {
			...
			var cost = this.category.oldPricing.pricePerHourLow / 60 * this.highAndLowMinutes.low;
	...
	return Ride;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'category', [_mobx.observable], {
	enumerable: true,
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, 'distance', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {
			value: undefined,
...
}), _applyDecoratedDescriptor(_class.prototype, 'changeCategory', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'changeCategory'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'highAndLowMinutes', [_mobx.computed], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'highAndLowMinutes'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'newCost', [_mobx.computed], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'newCost'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'newToOldDifference', [_mobx.computed], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'newToOldDifference'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'oldCost', [_mobx.computed], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'oldCost'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'validateStartTime', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'validateStartTime'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'validateDuration', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'validateDuration'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'validateDistance', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'validateDistance'), _class.prototype)), _class);
...
var _tape = __webpack_require__(6);
...
(0, _tape2.default)('returns correct values', function (t) {
	var testData = [[10, 0, 2, 5, 125, 0], [6, 0, 1, 0, 0, 60], [6, 0, 2, 0, 60, 60], [6, 0, 24, 0, 16 * 60, 8 * 60], [23, 59, 0, 2, 0, 2], [22, 59, 0, 2, 1, 1]];
	testData.forEach(function (datum) {
		t.deepEquals((0, _getHighAndLowHours2.default)({ hours: datum[0], minutes: datum[1] }, { hours: datum[2], minutes: datum[3] }), { high: datum[4], low: datum[5] });
	});
	t.end();
});
...
/* WEBPACK VAR INJECTION */(function(__dirname) {var deepEqual = __webpack_require__(39);
var defined = __webpack_require__(7);
...
var toStr = Object.prototype.toString;
var slice = Array.prototype.slice;
var isArgs = __webpack_require__(47);
...
var $isFinite = __webpack_require__(51);

var sign = __webpack_require__(52);
var mod = __webpack_require__(53);
...
var inherits = __webpack_require__(13);
var through = __webpack_require__(3);
var resumer = __webpack_require__(60);
var inspect = __webpack_require__(61);
var bind = __webpack_require__(0);
var has = __webpack_require__(8);
...
(0, _tape2.default)('validates', function (t) {
	t.throws(function () {
		return (0, _parseTime2.default)('9:2');
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)('9:');
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)('9.142');
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)(':20');
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)('.20');
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)('-1');
	}, /Invalid/);
	t.end();
});

(0, _tape2.default)('x.xx or x:xx', function (t) {
	t.deepEquals((0, _parseTime2.default)(9), { hours: 9, minutes: 0 });
	t.deepEquals((0, _parseTime2.default)('9:20'), { hours: 9, minutes: 20 });
	t.deepEquals((0, _parseTime2.default)('9:00'), { hours: 9, minutes: 0 });
	t.deepEquals((0, _parseTime2.default)('24:00'), { hours: 24, minutes: 0 });
	t.deepEquals((0, _parseTime2.default)('29:50'), { hours: 29, minutes: 50 });
	t.end();
});

(0, _tape2.default)('x.x', function (t) {
	// Not if timeOfDay is true
	t.throws(function () {
		return (0, _parseTime2.default)('9.2', true);
	});
	t.deepEquals((0, _parseTime2.default)('9.2'), { hours: 9, minutes: 12 });
	t.end();
});

(0, _tape2.default)('knows minute bounds', function (t) {
	t.throws(function () {
		return (0, _parseTime2.default)('1:60');
	}, /Minutes/);
	t.throws(function () {
		return (0, _parseTime2.default)('1:-5');
	}, /Invalid/);
	t.end();
});

(0, _tape2.default)('knows hours', function (t) {
	t.throws(function () {
		return (0, _parseTime2.default)('-1:01', true);
	}, /Invalid/);
	t.throws(function () {
		return (0, _parseTime2.default)('24:01', true);
	}, /23/);
	t.throws(function () {
		return (0, _parseTime2.default)('24:00', true);
	}, /23/);
	t.end();
});
...
var _mobilityCalculatorApp = __webpack_require__(64);

var _mobilityCalculatorApp2 = _interopRequireDefault(_mobilityCalculatorApp);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function setupData() {
	var app = new _mobilityCalculatorApp2.default();
	var data = [
	// Birgit
	['Economy', '8:00', '11:30', 207, 127.37, 163.30], ['Budget', '8:00', '10:00', 139, 87.75, 96.45]
	// Biker
	, ['Micro', '14:30', '5:30', 168, 93.12, 122.95], ['Combi', '18:00', 2, 28, 26.56, 28.4]
	// Sebastian Aug
	...
	data.forEach(function (rideData) {
		app.rides.addRide();
		var ride = app.rides.rides[app.rides.rides.length - 1];
...
(0, _tape2.default)('calculations are correct', function (t) {
	var _setupData = setupData(),
	    app = _setupData.app,
	    data = _setupData.data;

	var oldCost = 0,
	    newCost = 0;
	app.rides.rides.forEach(function (ride, index) {
...
(0, _tape2.default)('discount', function (t) {
	var _setupData2 = setupData(),
	    app = _setupData2.app,
	    data = _setupData2.data;

	var originalCost = app.rides.total.oldCost;
...
var _carCategory = __webpack_require__(72);

var _carCategory2 = _interopRequireDefault(_carCategory);

var _getPricingConfig = __webpack_require__(73);

var _getPricingConfig2 = _interopRequireDefault(_getPricingConfig);

var _carCategories = __webpack_require__(74);

var _carCategories2 = _interopRequireDefault(_carCategories);

var _ride = __webpack_require__(29);

var _ride2 = _interopRequireDefault(_ride);

var _rides = __webpack_require__(91);

var _rides2 = _interopRequireDefault(_rides);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var MobilityCalculatorApp = function () {
	function MobilityCalculatorApp() {
		(0, _classCallCheck3.default)(this, MobilityCalculatorApp);

		this.categories = new _carCategories2.default();
		this._setupCategories();
		this.rides = new _rides2.default(this.categories);
		this.rides.addRide();
	}

	(0, _createClass3.default)(MobilityCalculatorApp, [{
		key: '_setupCategories',
		value: function _setupCategories() {
			var _this = this;

			(0, _getPricingConfig2.default)().forEach(function (config) {
				var cat = new _carCategory2.default(config.name, config.oldPricing, config.newPricing);
				_this.categories.addCategory(cat);
			});
		}
	}]);
	return MobilityCalculatorApp;
}();

exports.default = MobilityCalculatorApp;
...
$export($export.S + $export.F * !__webpack_require__(2), 'Object', { defineProperty: __webpack_require__(24).f });
...
* - pricePerKmMany
*/
function CarCategory(name, oldPricing, newPricing) {
	(0, _classCallCheck3.default)(this, CarCategory);
...
exports.default = getPricingConfig;
...
var log = (0, _debug2.default)('mobility:CarCategories');

var CarCategories = function () {
	function CarCategories() {
		(0, _classCallCheck3.default)(this, CarCategories);

		this.categories = [];
	}

	(0, _createClass3.default)(CarCategories, [{
		key: 'addCategory',
...
try {
  var supportsColor = __webpack_require__(79);
...
const os = __webpack_require__(80);
const hasFlag = __webpack_require__(81);
...
var $getOwnPropertyDescriptor = __webpack_require__(87).f;
...
var log = (0, _debug2.default)('mobility:Rides');

var Rides = (_class = function () {
	function Rides(categories) {
		(0, _classCallCheck3.default)(this, Rides);

		_initDefineProp(this, 'rides', _descriptor, this);

		_initDefineProp(this, 'discount', _descriptor2, this);

		this._latestId = 0;
		this._categories = categories;
	}

	(0, _createClass3.default)(Rides, [{
		key: 'setDiscount',
		...
		value: function addRide() {
			var id = this._latestId++;
			log('Add ride with id %d, cats %o', id, this._categories);
			this.rides.push(new _ride2.default(id, this._categories));
		}
	}, {
		key: 'removeRide',
		value: function removeRide(ride) {
			this.rides.splice(this.rides.indexOf(ride), 1);
		}
	}, {
		key: 'total',
		get: function get() {
			var cost = this.rides.reduce(function (prev, ride) {
				if (!ride.oldCost || !ride.newCost) return prev;
				var oldCost = prev.oldCost,
				    newCost = prev.newCost;

				oldCost += ride.oldCost;
				newCost += ride.newCost;
				return { oldCost: oldCost, newCost: newCost };
			}, { oldCost: 0, newCost: 0 });
			log('total is %o', cost);
			var discount = this.discount.value ? 1 - this.discount.value / 100 : 1;
			var oldCost = cost.oldCost * discount;
			var relative = cost.newCost && oldCost ? cost.newCost / oldCost - 1 : 0;
			return {
				oldCost: oldCost,
	...
	return Rides;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'rides', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return [];
	}
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'discount', [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {
			value: undefined,
...
}), _applyDecoratedDescriptor(_class.prototype, 'setDiscount', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'setDiscount'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'addRide', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'addRide'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'removeRide', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'removeRide'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'total', [_mobx.computed], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'total'), _class.prototype)), _class);
